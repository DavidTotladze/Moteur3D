...
namespace M3D_ISICG
{
	...
	Mat4f Camera::_computeViewMatrix()
	{ 
		return glm::lookAt( _position, -_invDirection, _up );
	}

	Mat4f Camera::_computeProjectionMatrix()
	{ 
		return glm::perspective( _fovy, _aspectRatio, _zNear, _zFar );
	}
